...
setwd("/scratch/bal7cg/Yang_Adam")
                ...
                ORIGINALOUTPUTGRMS = "/scratch/bal7cg/Yang_Adam/GWAS_withGRMs/NewPhenoOutputsWithGRMS/"
                #folder for permutated GWAS with GRMs
                PERMSOUTPUTGRMS = "/scratch/bal7cg/Yang_Adam/GWAS_withGRMs/PermsOutputsWithGRMS/"
                #folder for observed GWAS without GRMs
                ORIGINALOUTPUTNOGRMS = "/scratch/bal7cg/Yang_Adam/GWAS_withoutGRMs/NewPhenoOutputsWithoutGRMS/"
                #folder for permutated GWAS without GRMs
                PERMSOUTPUTNOGRMS = "/scratch/bal7cg/Yang_Adam/GWAS_withoutGRMs/PermsOutputsWithoutGRMs/"
